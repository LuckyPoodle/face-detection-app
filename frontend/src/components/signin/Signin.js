        ...
        <div className="measure">
          <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
            ...
            <div className="mt3">
              ...
              className="pa2 input-reset ba bg-transparent hover-bg-black white w-100" type="email" name="email-address"  id="email-address"/>
            </div>
            <div className="mv3">
              <label className="db fw6 lh-copy f6" htmlFor="password">Password</label>
              <input 
              onChange={this.onPasswordChange}
              className="b pa2 input-reset ba bg-transparent hover-bg-black white w-100" type="password" name="password"  id="password"/>
            </div>
